exports.config = {
    ...
    wdi5: {
        ...
        url: "flpSandbox.html?sap-language=de", // [mandatory] {string} name of your bootstrap html file. If your server autoredirects to a 'domain:port/'-like root url, use empty string ''
